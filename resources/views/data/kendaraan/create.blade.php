...
@section('page-description', 'Create a new vehicle entry')
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Fill in the vehicle information below</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form action="{{ route('kendaraan.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="no_polisi" value="{{ old('no_polisi') }}" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('no_polisi') border-red-500 @enderror" placeholder="e.g., B 1234 XYZ">
                            @error('no_polisi')
                        ...
                        <div>
                            ...
                            <input type="text" name="merk" value="{{ old('merk') }}" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('merk') border-red-500 @enderror" placeholder="e.g., Toyota">
                            @error('merk')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="type" value="{{ old('type') }}" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('type') border-red-500 @enderror" placeholder="e.g., Avanza">
                            @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="tahun" value="{{ old('tahun') }}" required min="1900" max="{{ date('Y') + 1 }}" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('tahun') border-red-500 @enderror" placeholder="e.g., 2020">
                            @error('tahun')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="warna" value="{{ old('warna') }}" required class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('warna') border-red-500 @enderror" placeholder="e.g., Hitam">
                            @error('warna')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="no_rangka" value="{{ old('no_rangka') }}" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('no_rangka') border-red-500 @enderror" placeholder="Vehicle chassis number">
                            @error('no_rangka')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="no_mesin" value="{{ old('no_mesin') }}" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('no_mesin') border-red-500 @enderror" placeholder="Engine number">
                            @error('no_mesin')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="user" value="{{ old('user') }}" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('user') border-red-500 @enderror" placeholder="Current user">
                            @error('user')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="keterangan" rows="4" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('keterangan') border-red-500 @enderror" placeholder="Additional notes about this vehicle">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
