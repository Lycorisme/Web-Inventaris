...
@section('form-title', 'Form Tambah Data Kendaraan Total Kendaraan')
...
<form method="POST" style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
    ...
    <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div>
            ...
            <input type="text" name="status_komisioning" placeholder="Masukkan Status" style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 6px; font-size: 13px;" required>
        </div>
    </div>
